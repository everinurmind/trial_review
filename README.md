...
Hello! Here i will review the code from the project that we've completed during the Admissions Trials.
...
- [will be training my review skills] **[Project Review]**

<p align="right">(<a href="#readme-top">back to top</a>)</p>

## 🚀 Live Demo <a name="live-demo"></a>

- [Live Demo Link](https://github.com/everinurmind/trial_review)
...
Feel free to check the [issues page](https://github.com/everinurmind/trial_review/issues).
...
Thanks to Mathías Wismann, for sharing code of this project with me.
